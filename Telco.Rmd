...
telco_ann <- neuralnet(Churn ~., data = telco_train_normal)

plot(telco_ann)

ann_results <- compute(telco_ann, telco_test_normal[1:30])
...
dtpred <- predict(dt, telco_test_normal)

# Build a confusion matrix
confusionMatrix(data = dtpred, reference = as.factor(telco_test_labels), positive = "1")
```
