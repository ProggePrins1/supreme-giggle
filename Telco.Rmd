...
# confusion, but just beware that he "chr" variables will be turned into factors later on. Similarly, 
...
# Interesting finding here: for the "No" option in DeviceProtection, the churn is relatively high compared to the other values in this category. Again, the male-female split appears to be almost 
# exactly 50% in every kind of DeviceProtection.

# Next, how does the tenure affect churn? Perhaps customers who have stuck around for a while will continue to stick around and thus need less discounts, etc.?
