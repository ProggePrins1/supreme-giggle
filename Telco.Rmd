...
ggplot(model_sensitivity_df, aes(x = success_rates, y = profits_vector_mi)) + geom_line()
```
<br>
...
animation <- data.frame(success_rates, profits_vector, profits_vector_mi) %>%
  ...
  geom_hline(yintercept = -1 * lost_profit_no_retention, linetype = 4, aes(color = "No Retention")) +
  geom_hline(yintercept = 0, linetype = "F1", color = "black") + 
  ggtitle("Profitability at Different Retention Program Success Rates") +
  scale_x_continuous(expand = c(0, 0), limits = c(0, 1)) +
  scale_y_continuous(expand = c(0, 0), limits = c(-2000000, 500000)) +
  xlab("Success Rates") +
  ylab("Profit") +
  theme_light() +
  scale_color_manual(values = c("Random Selection" = "#484444", "Model Selection" = "red", "No Retention" = "black"), name = "Scenarios") +
  theme(plot.title = element_text(family = "Helvetica", face = "bold", size = 20),
        ...
        axis.text.y = element_text(face = c('plain', 'plain', 'plain', 'plain', 'bold', 'plain'), size = 16),
